...
struct WhisperKitRunner {
    ...
    void buildPipeline() {
        printf("Building WhisperKitPipeline\n");
        ...
        printf("Setting WhisperKitPipeline configuration\n");
    ...
    void transcribe() {
        ...
        printf("Creating WhisperKitTranscriptionResult\n");
     ...
     ~WhisperKitRunner() {
        printf("Destroying WhisperKitRunner\n");
        if (pipeline) {
