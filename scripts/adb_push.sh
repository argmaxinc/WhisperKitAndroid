...
REMOTE_TINY_DIR="${REMOTE_SDROOT_DIR}/models/openai_whisper-tiny"
REMOTE_BASE_DIR="${REMOTE_SDROOT_DIR}/models/openai_whisper-base"
REMOTE_SMALL_DIR="${REMOTE_SDROOT_DIR}/models/openai_whisper-small"
