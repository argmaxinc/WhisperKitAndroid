...
TFLiteGPU::TFLiteGPU(const string& name) : TFLiteModel(name) {}

TFLiteGPU::~TFLiteGPU() { uninitialize(); }

bool TFLiteGPU::initialize(string model_path, string lib_dir, string cache_dir, int backend, bool debug) {
