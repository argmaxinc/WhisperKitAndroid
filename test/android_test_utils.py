...
class TestRunADB:
    ...
    def __init__(
        ...
        Args:
            bin_path, lib_path:     
                Path under /data/local/tmp for exec binary & library files
    ...
    def _put_test_info(self, data_set):
        device_info = {}
        ...
        self.output_json["testInfo"]["reference"] = "None"
